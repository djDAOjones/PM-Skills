<!-- field-report: project=route-plotter · date=2026-08-26 · type=export
     · pm-skills=4.7.0
     · source=tracked reviews tree at public snapshot 6f2ac154430be665a9cb1665a6f20d1b317990e0
     · redaction=2 checkout path occurrence(s) and 0 other home-path occurrence(s) collapsed; 0 e-mail address(es) replaced; no credential-shaped values found
...
Snapshot: `6f2ac154430be665a9cb1665a6f20d1b317990e0`. Uncommitted review edits are excluded here and captured only in the local working-tree snapshot.
