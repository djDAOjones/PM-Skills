<!-- field-report: project=uon-video-helper · date=2026-08-24 · type=export
     · pm-skills=4.9.2
     · source=tracked original brief and PM Skills initialisation prompt at git commit 09702c2d8c749e72943678c94c558cf33ac1270f
...
# UoN Video Helper initial-brief and initialisation-prompt export

| Source file | Bytes at snapshot |
| --- | ---: |
| `docs/00-original-brief.md` | 12,209 |
| `docs/04-init-prompt.md` | 5,320 |
| **Total** | **17,529** |
