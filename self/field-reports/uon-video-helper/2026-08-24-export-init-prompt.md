<!-- field-report: project=uon-video-helper · date=2026-08-24 · type=export
     · pm-skills=4.9.2
     · source=docs/ from the project, harvested by Claude Code -->

# Init prompt, brief and open decisions — uon-video-helper

The project kept the prompt it was initialised with, together
with the brief that prompt was written from and the
open-decisions register it opened. This is the scarcest kind of
evidence the framework can hold: the actual input to a stand-up,
preserved rather than reconstructed, for a project whose entire
subsequent history sits in the same directory.
...
<!-- FILE: docs/00-original-brief.md -->
...
<!-- FILE: docs/03-open-decisions.md -->
