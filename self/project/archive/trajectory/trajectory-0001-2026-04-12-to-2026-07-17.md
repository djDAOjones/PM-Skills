# Trajectory archive 0001 — 2026-04-12 → 2026-07-17

<!-- Cold tier: grep only, never auto-read. Append-only, verbatim —
     phases moved whole from self/project/trajectory.md by the Prune
     verb (ARCH-RETENTION, 2026-08-27), never rewritten. Range is the
     span actually archived; see archive/INDEX.md for the item IDs. -->
