---
flags: ALERT
current-intent: LAB-FIRST alert gates the queue (maintainer order 2026-08-23) — the lab arc runs first. VOICE-INTAKE promoted at the 2026-08-18 Re-assess pass (first live run of the 4.9.0 verb) — the next arc, blocked on maintainer inputs (real transcripts plus the external preparation prompts).
